            ...
            <a class="header__link">
              <transition name="slide-fade">
                ...
                <button
                  ...
                  @click="show = true"
                >
                  <img src="@/assets/images/admin.svg" class="header--icon" />
                </button>
              </transition>
            </a>
            <!-- Dropdown Menu -->
              ...
              >
                <ul class="dropdown__menu-nav">
                  <li class="dropdown__menu-item">
                    <a class="dropdown__menu-link" title="Account">
                      ...
                      <div class="dropdown__menu-text">管理紀錄</div>
                    </a>
                  </li>
                  <li class="dropdown__menu-item">
                    <a class="dropdown__menu-link" title="Personal info">
                      ...
                      <div class="dropdown__menu-text">帳號信息</div>
                    </a>
                  </li>
                  <!-- <li class="dropdown__menu-item">
                  ...
                  <li class="dropdown__menu-item">
                    ...
                    >
                      ...
                      <div class="dropdown__menu-text">登出</div>
                    </a>
                  </li>
...
.dropdown__menu-link:hover {
  color: #6E60F6;
  background-color: rgba(110, 96, 246, 0.1);
}
.dropdown__menu-svg {
  width: 1.5rem;
  height: 1.5rem;
